...
export const driverSummary = [
  ...
  { title: "本月平均出勤", value: "10 天", detail: "按司机档案与月度排班统计" },
  { title: "默认车辆已绑定", value: "5 人", detail: "排班时可自动带入常用车辆" },
];
